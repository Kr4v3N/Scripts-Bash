...
#
#Je vais vous demander de créer un script Bash qui fournit des statistiques sur l'utilisation des lettres dans une langue. Pour cela, vous allez devoir vous baser sur un fichier de dictionnaire contenant tous les mots de la langue française.
#
#Mission n°1 : combien de fois est utilisée chaque lettre ?
#
#A partir de ce fichier (dico.txt) vous devez extraire le nombre de mots utilisant chaque lettre de l'alphabet de A à Z. Le script que vous allez créer prendra en paramètre le nom du fichier dictionnaire à analyser.
#
...
#
# Vous connaissez la plupart des commandes vous permettant de réaliser ce script : vous les avez apprises dans ce cours. Cependant, la lecture du manuel et quelques recherches sur le Net vous seront probablement indispensables.
#
clear
