...
#
#Alice maîtrise enfin les commandes du Bash, mais elle n'a malheureusement pas suivi la quatrième séquence de ce MOOC...
# Donc elle compte toujours sur vous pour lui écrire des scripts.
# Son autre souci, c'est qu'elle aime manger des fruits pour son goûter, et entre pomme, pêche, poire, et abricot,
# elle ne sait jamais quel fruit choisir.
#
# Pour l'aider dans ce choix critique, votre mission est d'écrire le script ploumploum.sh.
# Ce script attend un nombre quelconque d'arguments (au maximum 120) et
# doit choisir l'un d'entre eux au hasard afin de l'afficher sur la console.
#
#la fonction alea
alea() {
    return $(((RANDOM % $1)+1))
